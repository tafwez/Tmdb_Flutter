...
class TvSeeAll extends StatefulWidget {
  final String? title;
  final String? category;
  final String? mediaType;

  const TvSeeAll({super.key, this.title, this.category, this.mediaType});

  @override
  State<TvSeeAll> createState() => _SeeAllState();
}

class _SeeAllState extends State<TvSeeAll> {
  // Cubits
  late final MainCubit _tvCubit;
  ...
  void _fetchMoviesForPage(int pageNumber) {
    ...
    _tvCubit.stream.first.then((state) {
